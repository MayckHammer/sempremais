          ...
          <div className="rounded-3xl overflow-hidden shadow-premium border border-border/40 bg-card">
            <div className="relative w-full h-32 bg-muted">
              <iframe
                ...
                src={`https://www.google.com/maps/embed/v1/view?key=src={`https://www.google.com/maps/embed/v1/view?key=AIzaSyCMLByhTQlf1RBbqWzdJb-DCbJxwOC_HL4&center=${location.lat},${location.lng}&zoom=13`}&center=${location.lat},${location.lng}&zoom=13`}
              />
            </div>
          </div>
