...
export function SBBadge({ position = 'bottom' }: { position?: 'bottom' | 'top' }) {
  ...
  return (
    <button
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center gap-2 bg-foreground/40 backdrop-blur-md text-background rounded-full px-5 py-3 shadow-elevated hover:scale-105 active:scale-95 transition-transform duration-200 overflow-hidden sb-shimmer data-[position=top]:bottom-auto data-[position=top]:top-4 data-[position=top]:right-4 data-[position=top]:px-3 data-[position=top]:py-1.5"
